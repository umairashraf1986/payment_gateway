...
<input name="key" type="hidden" value="PLEASE ENTER YOUR API KEY HERE" />
<input name="process_mode" type="hidden" value="refund" />
<input name="redirect_url" type="hidden" value="PLEASE ENTER THE REDIRECT URL HERE" />
<tr>
