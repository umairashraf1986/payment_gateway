<?php 
	...
	//////////////////////// Allow Pages List for Super Admin /////////////////////////////
		$allow_pages = array('',
							 'list_merchants',
							 'edit_subadmin',
							 'list_transections',
							 ...
							 'view_admin',
							 'edit_admin',
							 'profile');  // '', blank is used to view admin.php
		
		if($_SESSION['adminauth']['role'] == 1 && !in_array($_REQUEST['act'],$allow_pages)){
			echo "Access Denied";
			exit();	
		}
    //////////////////////// Allow Pages List for Sub Admin /////////////////////////////
		$allow_pages = array('',
							 ...
							 'details_transaction',
							 'update_order_status',
							 'edit_subadmin');  // '', blank is used to view admin.php
