<?php 
		if($_POST['merchant_save']) {
				...
				$sql_merchant1 = "SELECT * FROM ".$tblprefix."merchants WHERE merchant_website = '".mysql_real_escape_string($_POST['merchant_website'])."'";
...
#log li span.cancel{ position:absolute; top:5px; right:5px; width:20px; height:20px; background:url('file://///192.168.1.17/Dev/paymentgatway/admin/bodies/javascript/swfupload/cancel.png') no-repeat; cursor:pointer; }
                  ...
                  <table width="100%" class="txt" border="0">
                    ...
                    <tr>
                     ...
                     <tr>
                       ...
                       <td>
                            <input class="fields" type="text"  name="refund_email" id="refund_email" value="" /><br />
                    ...
                    <td>
                        <div style="display:none; width:600px;" id="api_div">
                            <table border="0" width="75%" class="txt">
                    
                     <tr>
                            <td>Client ID:</td>
                            <td><input class="fields" type="text" name="client_id" id="client_id" value="" /> <span style="font-size:12px; color:#999">- Not Required for Binary Folder</span></td>
                    </tr>
