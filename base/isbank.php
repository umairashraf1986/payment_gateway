<?php	
	...
	if($payment_mode == 'Live') {
		$url = "https://spos.isbank.com.tr/servlet/cc5ApiServer";
		...
		$name = 'ISBANKAPI';       				//API Username	"ISBANKAPI"
		$password = 'ISBANK07';    			//API Pass		"ISBANK07"
		$clientid = '700100000';    		//VPOS MID 		clientid= "700100000"
	} // END of ELSE
	...
	if($api_mode == 1) {
		...
		$email = "tesssttt@testing.com";	    //email
		// $api_mode= '0';
	} // END of ELSE
	...
	$type = "Auth";   					//Auth: Sale
	$ccno = $ccno;          				//CC No    4508034508034509
	$exp_date_month = $cc_exp_month;      //Exp Date Month  (format:MM) "12"
	$exp_date_year = "20".$cc_exp_year;              //Exp Date Year   (format:yyyy)
	
	//$amount="1.01";   				// "." MUST be used as the decimal separator
