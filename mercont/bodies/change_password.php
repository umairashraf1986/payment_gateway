...
<?php		
		...
		if(strlen($new_password) > 0) 
			$change_pass_sql = ", mercht_password='".base64_encode($new_password)."'";
		else 
			$change_pass_sql = '';
		
		$update_admin = "UPDATE ".$tblprefix."merchants SET cc_successful_email_body = '".$cc_successful_email_body."' $change_pass_sql WHERE merchant_id='".$_SESSION['adminauth']['id']."' ";					
...
<?php		
	...
	$qry_merc = "SELECT cc_successful_email_body FROM ".$tblprefix."merchants WHERE  merchant_id='".$_SESSION['adminauth']['id']."'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="txt">
  <tr>
    <td width="77%" height="28" align="left" valign="middle" class="white_txt">
        <strong>
			<?php
                if(isset($_GET['msg'])){
