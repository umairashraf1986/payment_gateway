 ...
 <form id="form_search" name="form_search" action="admin.php?act=details&mid=<?php echo $merchant_id; ?>&stype=<?php echo $_REQUEST['stype']; ?>&bid=<?php echo $bank_id; ?>&order=<?php echo base64_encode($order_str); ?>&pl=<?php echo $_REQUEST['pl']; ?>" method="post">
  ...
  <tr id="heading"> 	
        ...
        <td width="15%" align="left">
        	<a href="admin.php?act=details&mid=<?php echo $merchant_id; ?>&stype=<?php echo $stype; ?>&<?php echo $str_str; ?>&bid=<?php echo $bank_id; ?>&pl=<?php echo $_REQUEST['pl']; ?>&order=<?php echo base64_encode('transaction_datetime '.$order_type); ?>" style="color:#FFF; font-size:12px;"><strong> Date/Time</strong></a>
        </td>
        ...
        <tr valign="top">		
            ...
            <td width="10%" align="left">
			<?php 					
				$cc_last_no = substr($row_search['creditcard_no'], -4);  // abcdef it gives last 4 cdef characters
           ...
           <td width="10%" align="center">
           	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?act=details_transaction&mid=<?php echo $merchant_id; ?>&<?php echo $str_str; ?>&pl=<?php echo $_REQUEST['pl']; ?>&bid=<?php echo $bank_id; ?>&trans_id=<?php echo $row_search['rp_id']; ?>" target="_parent">Details</a>
           </td>
        </tr>
...
<script type="text/javascript" language="javascript">
	function pagelimit() {
		...
		window.location.href="admin.php?act=details&mid=<?php echo $merchant_id; ?>&bid=<?php echo $bank_id; ?>&status=<?php echo $status_response;?>&years=<?php echo $find_years;?>&months=<?php echo $find_months;?>&pl="+pagelimit;
