...
<table width="101%" border="0" cellspacing="0" cellpadding="0" class="txt">
  ...
  <?php 
    ...
    <?php
		...
		$db_view2 = "SELECT * FROM crm_transaction_log WHERE merchant_id = '$merchant_web'";
  ...
  <tr valign="top" bgcolor="<?php //echo $bg ; ?>">
	...
	//////////////////////////////////////////////////////////////////////////////	
		...
		$Last_Month_Transaction = "SELECT * FROM crm_transaction_log
		 WHERE transaction_date BETWEEN '$LastMonthDate' AND '$TodayCurrentDate' ";
	...
	//////////////////////////////////////////////////////////////////////////////	
		...
		$Last_Week_Transaction = "SELECT * FROM crm_transaction_log
		 WHERE transaction_date BETWEEN '$LastWeekDate' AND '$TodayCurrent_date' ";
