...
{
	echo "No Rsult Found";// $sql = "select * from ".$tblprefix."models";
}
...
<?php 
  ...
  <tr valign="top" bgcolor="<?php echo $bg ; ?>">
    ...
    <img src="<?php echo SURL; ?>uploads/products/<?php echo $rs_image->fields['image'];?>" width="50" height="50"></td>
   <?php }
   else {
	?>
...
<?php 
if($isrs==0){ echo '<div class="no-rec">No Record Found !</div>';}?>