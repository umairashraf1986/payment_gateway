...
exit;	
	...
	$sql = "select Id, CountryName from ".$tblprefix."country ORDER BY CountryName ASC";
	$rs = $db->Execute($sql);
	$isrs = $rs->RecordCount();
...
<table width="650" border="0" cellspacing="0" cellpadding="2" class="txt" align="center">
	...
	<tr>
		...
		<td width="67%"><select name="typelist" size="1" id="typelist" class="fields">
...
?>
	...
	<tr>
	  ...
	  <td><select name="security_ques" class="fields"  />
