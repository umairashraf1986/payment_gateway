<?php	
	...
	// LIVE: $url = "https://sanalpos.halkbank.com.tr/servlet/cc5ApiServer"

	if($payment_mode == 'Live') {
		$url = "https://sanalpos.halkbank.com.tr/servlet/cc5ApiServer";
	
		$name = $api_user;       	     	//API Username   "KUVEYTTURKAPI"
		$password = $api_pass;    	    //API Pass   "KUVEYTTURK11"
		$clientid = $api_client_id;    	//VPOS MID  "110000000"
	} else {
		$url = "https://testsanalpos.est.com.tr/servlet/cc5ApiServer";  //TEST	
		$name = 'HALKTESTAPI';       	     	//API Username   "KUVEYTTURKAPI"
		$password = 'HALKTEST123';    	    //API Pass   "KUVEYTTURK11"
		$clientid = '500500000';    	//VPOS MID  "110000000"
...
$type="Auth";   				  //Auth: Sale
$ccno = $ccno;         			  //CC No 4025894025894022
$exp_date_month = $cc_exp_month;    //Exp Date Month  (format:MM) "12"
$exp_date_year = $cc_exp_year;     //Exp Date Year   (format:yyyy) "12"
								
	// $amount;  // Get Amount from Checkout base page	// "." 10.05 MUST be used as the decimal separator
...
//Fill in te parameters
	  ...
	  ////////////////////////////////////////////////////////////////////////////////////////////
		...
		$error_desc = $php_array['CC5Response']['ErrMsg']['value'];
		...
		?>
					<AXOPResponse>
                        ...
                        <ErrorDesc>Could not connect with the Server</ErrorDesc>
					</AXOPResponse>        
		<?php			
					exit() ;
