		...
		$sql_merchant1 = "SELECT 
				...
				///////////////////////////////////////////////////////////////////////////////////////////////
					...
					$update_qauer = "UPDATE 
									...
									mercht_password  = '".$merchant_password."',
  		...
  		<td>
   		 ...
   		 <table width="100%" class="txt">
             ...
             <tr>
              	<td>Account Type:</td>
            	<td>Merchant Hosting
  	  <input type="radio" name="hosting_type" value="1" <?php if($rs1->fields['api_mode']==1) { ?> checked="checked" <?php } ?> />
                Server Hosting
      <input type="radio" name="hosting_type" value="0" <?php if($rs1->fields['api_mode']==0) { ?> checked="checked" <?php } ?> />
               	</td>
            </tr>
              ...
              <tr>
              		...
              		<td><input class="fields" type="text"  name="merchant_password" id="merchant_password" value="" /> <span style="font-size:11px; color:#999"> - Password cannot be shown for Security Reasons</span></td>
              </tr>
              <tr>               
               <td>Merchant ID:</td>
               <td>
			...
			<tr>
               ...
               <td><input class="fields" type="text"  name="refund_email" id="refund_email" value="<?php echo stripslashes($rs1->fields['refund_email']); ?>" /></td>
             </tr>              
            ...
            <td>
            	<div style="width:400px;<?php if($rs1->fields['payment_mode'] == 'Live'){ echo "display:block;"; }else {?> display:none;  <?php }?>" id="api_div">
					
    	        	<table border="0" width="96%" class="txt">

                         <tr>
                                <td>Client ID:</td>
                                <td><input  class="fields" type="text" name="client_id" id="client_id" value="<?php echo stripslashes($rs1->fields['client_id']); ?>">
                               </td>
                          </tr> 
